...
public abstract class AbstractDockerCommand extends OsgiCommandSupport {

    private KarafDocker docker;

    @Argument(index = 0, name = "name", description = "The name of the dock", required = true, multiValued = false)
    String name;
